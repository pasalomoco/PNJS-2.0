class Personaje {
  ...
  crearTipoPNJ () {
    ...
    if(tirada >= 0 && tirada <= 10){
      ...
      this.puntosTotalesCaracteristicas =  [1 , 1, , 0,  0]
      ...
      this.baseMente = 3;
      this.baseHabilidades = 3;
      this.puntosTotalesCaracteristicas =  [2 , 1, , 1,  0]
      ...
      this.puntosTotalesCaracteristicas =  [2 , 2, , 1,  0]
      ...
      this.puntosTotalesCaracteristicas =  [2 , 2, , 2,  1]
      ...
      this.puntosTotalesCaracteristicas =  [3 , 3, , 2,  2]
    ...
    switch (this.tipoPNJ) {
      case "Inútil":
        for (let i = this.puntosRagosAdicionales; i >= 1; i--) {
          rasgosAdicionales.push(sacarRasgosAdicionalesRandom());
        }
      break;
      case "Pringao":
        for (let i = this.puntosRagosAdicionales; i >= 1; i--) {
        ...
        if(caracteristicas[caracteristicaRandom]  + i > 10  ){
          j--
            ...
            if(caracteristicaRandom in espiritu){
              ...
              console.log("Ha tocado espíritu con bonificador de "+i)
              console.log("La tocada: "+caracteristicaRandom)
              console.log("La contraria: "+contraria)
              caracteristicas[caracteristicaRandom] = caracteristicas[caracteristicaRandom]  + i;
              sumaCaracteristica = caracteristicas[caracteristicaRandom]+caracteristicas[contraria]
              if(sumaCaracteristica > 10 && caracteristicas[contraria] > this.baseEspiritu){
                checkEspiritu == true;
              }
              console.log("Le sumo "+i+" a  "+caracteristicaRandom + " quedándose en:   "+caracteristicas[caracteristicaRandom])
              console.log("La suma de ambas es: "+sumaCaracteristica)
              if(!checkEspiritu){
                if(sumaCaracteristica > 10){
                  while( (caracteristicas[caracteristicaRandom] + caracteristicas[contraria]) >10) {
                    ...
                    console.log("Le restamos uno a la contraria "+ contraria)
                    console.log(caracteristicas[contraria])
                  }
                }
              }else{
                j--
